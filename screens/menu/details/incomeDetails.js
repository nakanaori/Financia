...
export default class IncomeDetails extends React.Component {
    ...
    deleteData = (id, category) => {
        rootRef.child('Income').child(firebase.auth().currentUser.uid).child(category).child(id.toUpperCase()).remove(() => {
            ...
            <View style={styles.descriptionDetail}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('IncomeUpdateScreen', {
                            category : category,
                            id : id,
                        })}>
    ...
    insertData() {
        return new Promise((resolve, reject) => {
            ...
            rootRef.child('Income').child(firebase.auth().currentUser.uid).child(category).on('value', (snapshot) => {
                if (snapshot != null) {
                    details.length = 0;
